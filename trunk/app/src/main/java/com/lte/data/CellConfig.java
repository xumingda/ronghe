                ...
                synchronized (this){
                    ...
                    if(plmn != null && plmn.size() != 0){
                        ...
                        for(int i = 0; i< plmn.size();i++){
                            pLmnListTag[i] = 23;
                            pLmnListTag[i+1] = 0x00;
                            pLmnListTag[i+2] = 0x04;
                            pLmnListTag[i+3] = (byte) ((plmn.get(i) >> 24) & 0xFF);
                            pLmnListTag[i+4] = (byte) ((plmn.get(i) >> 16) & 0xFF);
                            pLmnListTag[i+5] = (byte) ((plmn.get(i) >> 8) & 0xFF);
                            pLmnListTag[i+6] = (byte) ((plmn.get(i) >> 0) & 0xFF);
                        }
                    }
