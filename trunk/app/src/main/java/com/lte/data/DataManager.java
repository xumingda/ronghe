                ...
                try {
                    ...
                    mHandRealm.executeTransaction(new Realm.Transaction() {
                                                      ...
                                                      public void execute(Realm realm) {
                                                          ...
                                                          Log.d(TAG, "ImsiData :" + imsiData.toString());
                                                          ...
                                                          if (imsi != null) {
                                                              imsiDataTable.setMobile(imsi.getMobile());
                                                          }
...
//        mRealm = Realm.getDefaultInstance();
    ...
    public void crateOrBlackUpdate(final String imsi, final String imei, final String mobile) {
...
//                    mRealm = Realm.getDefaultInstance();
    ...
    public void crateOrUpdateWhite(final String imsi, final String imei, final String mobile) {
        handler.post(new Runnable() {
            @Override
            public void run() {
                try {
