...
public class WhiteAdapter extends RealmRecyclerViewAdapter<WhiteListTable,WhiteAdapter.MViewHolder> {
    private final static String TAG = "FunctionAdapter";
    private LayoutInflater mInflater;
    private OrderedRealmCollection<WhiteListTable> mList;
    private Context mContext;
    private CheckListener onCheckListener;
    private final RecyclerView recyclerView;

    public WhiteAdapter(Context context, OrderedRealmCollection<WhiteListTable> list, CheckListener onCheckListener, RecyclerView recyclerView) {
    ...
    public void upDataList(OrderedRealmCollection<WhiteListTable> mList) {
        this.mList = mList;
    ...
    public void onBindViewHolder(MViewHolder holder, int position) {
        final WhiteListTable imsiData = mList.get(position);
...
//            bbu = (TextView)itemView.findViewById(R.id.bbu);
    ...
    public interface CheckListener{
        void onClick(View view, WhiteListTable imsiData);
    }
}
