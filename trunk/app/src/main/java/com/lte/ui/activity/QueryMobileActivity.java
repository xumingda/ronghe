    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.add_button:
                ...
                localProgressFlag.set(DialogManager.showProgressDialog(QueryMobileActivity.this, "正在提交，请稍候.."));
                mHandler.sendEmptyMessageDelayed(TIME_OUT, 30 * 1000l);
                break;
            case R.id.query_button:
                localProgressFlag = new AtomicReference<>();
                //localProgressFlag.set(DialogManager.showProgressDialog(QueryMobileActivity.this, "查询中，请稍候.."));
