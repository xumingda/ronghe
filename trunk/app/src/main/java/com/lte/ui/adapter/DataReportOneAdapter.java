...
//                holder.number.setTextColor(ViewUtil.getColor(mContext,R.color.red));
            ...
            if (imsiData.getMobile() == null) {
                holder.operator.setTextColor(ViewUtil.getColor(mContext, R.color.blue));
                holder.imsi1.setTextColor(ViewUtil.getColor(mContext, R.color.blue));
                holder.xuhao.setTextColor(ViewUtil.getColor(mContext, R.color.blue));
                holder.timestamp.setTextColor(ViewUtil.getColor(mContext, R.color.blue));
                holder.bbu.setTextColor(ViewUtil.getColor(mContext, R.color.blue));
                holder.mobile.setTextColor(ViewUtil.getColor(mContext, R.color.blue));
                holder.imei1.setTextColor(ViewUtil.getColor(mContext, R.color.blue));
                holder.attribution.setTextColor(ViewUtil.getColor(mContext, R.color.blue));
            } else {
