...
import com.lte.utils.SharePreferenceUtils;
...
//                            isSend = true;
                            ...
                            if (item == 9) {
                                num1++;
                                num2++;
                                if (num1 % 2 == 0 && isConnect() && Constant.isSpeak) {
                                    mHandler.removeCallbacks(sendCmdFail);
...
//            String fieldStrengthPow = "" + df.format((Constant.curr_value+118) /118);
            ...
            fieldStrength.setText(fieldStrengthPow);
        ...
        yAxis1.setAxisMaximum(250);
        yAxis2.setAxisMinimum(0);
        yAxis2.setAxisMaximum(250);
