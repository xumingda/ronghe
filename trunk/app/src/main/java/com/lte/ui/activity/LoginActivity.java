...
public class LoginActivity extends BaseActivity {
    ...
    private static final int CHECK_MAC = 6;
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case 5:
                    ...
                    break;
                case CHECK_MAC:
                    LETLog.d("MAC:"+getNewMac().toUpperCase());
                    if(!TextUtils.equals(getNewMac().toUpperCase(),"04:79:70:78:7A:08")){
                        try {
                            DialogManager.closeDialog(reference.get().localProgressFlag.get());
                        } catch (Exception e) {
                            e.printStackTrace();
...
//        checkMac();
    ...
    private void checkMac() {
        ...
        localProgressFlag.set(DialogManager.showProgressDialog(this, "申请权限中，请稍候.."));

        mUiHandler = new MUiHandler(this);
        mUiHandler.sendEmptyMessageDelayed(CHECK_MAC, 5 * 1000L);
    }
