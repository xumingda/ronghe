...
//					dialog.getWindow().setAttributes(params);
	...
	public static String showProgressDialog(Context context, String text) {
		return showProgressDialog(context,text,null);
	}
	public static String showProgressDialog(Context context, String text, final LocalCallInterface localCall) {
		return showProgressDialog(context,text,localCall,0);
	}

	public static String showProgressDialog(final Context context, String text, final LocalCallInterface localCall, int delayTime) {
